...
public:
	...
	TObjectPtr<UNLGameplayItemInstance> Item = nullptr;
};

USTRUCT(BlueprintType)
struct FGameplayItemPickup
{
	GENERATED_BODY()
...
public:
	...
	virtual FGameplayItemPickup GetPickupGameplayItem() const = 0;
};
...
public:
	...
	static void AddPickupToGameplayItem(UNLGameplayItemManagerComponent* GameplayItemComponent, TScriptInterface<IPickupable> Pickup);
};
