...
#include "NLCharacterPartTypes.generated.h"
...
struct FNLCharacterPart
{
	...
	static bool AreEquivalentParts(const FNLCharacterPart& A, const FNLCharacterPart& B)
	{
