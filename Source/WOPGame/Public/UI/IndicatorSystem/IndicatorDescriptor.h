...
class WOPGAME_API UIndicatorDescriptor : public UObject
{
	GENERATED_BODY()
...
public:
	UNLIndicatorManagerComponent* GetIndicatorManagerComponent() { return ManagerPtr.Get(); }
	void SetIndicatorManagerComponent(UNLIndicatorManagerComponent* InManager);
...
private:
	...
	UPROPERTY()
	TWeakObjectPtr<UNLIndicatorManagerComponent> ManagerPtr;
