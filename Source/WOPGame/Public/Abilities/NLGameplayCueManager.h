...
#include "NLGameplayCueManager.generated.h"
...
/**
 * UNLGameplayCueManager
 *
 * Game-specific manager for gameplay cues
 */
UCLASS()
class UNLGameplayCueManager : public UGameplayCueManager
{
	GENERATED_BODY()

public:
	UNLGameplayCueManager(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());

	static UNLGameplayCueManager* Get();
