...
#include "NLAbilityTagRelationshipMapping.generated.h"

class UObject;

/** Struct that defines the relationship between different ability tags */
USTRUCT()
struct FNLAbilityTagRelationship
{
	GENERATED_BODY()
...
UCLASS()
class UNLAbilityTagRelationshipMapping : public UDataAsset
{
	GENERATED_BODY()
...
private:
	...
	TArray<FNLAbilityTagRelationship> AbilityTagRelationships;
