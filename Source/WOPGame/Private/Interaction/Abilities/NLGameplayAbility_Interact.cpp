...
#include "Interaction/Abilities/NLGameplayAbility_Interact.h"
...
#include UE_INLINE_GENERATED_CPP_BY_NAME(NLGameplayAbility_Interact)
...
UNLGameplayAbility_Interact::UNLGameplayAbility_Interact(const FObjectInitializer& ObjectInitializer)
	: Super(ObjectInitializer)
{
	ActivationPolicy = ENLAbilityActivationPolicy::OnSpawn;
	InstancingPolicy = EGameplayAbilityInstancingPolicy::InstancedPerActor;
	NetExecutionPolicy = EGameplayAbilityNetExecutionPolicy::LocalPredicted;
}

void UNLGameplayAbility_Interact::ActivateAbility(const FGameplayAbilitySpecHandle Handle, const FGameplayAbilityActorInfo* ActorInfo, const FGameplayAbilityActivationInfo ActivationInfo, const FGameplayEventData* TriggerEventData)
{
...
void UNLGameplayAbility_Interact::UpdateInteractions(const TArray<FInteractionOption>& InteractiveOptions)
{
	if (ANLPlayerController* PC = GetNLPlayerControllerFromActorInfo())
	{
		if (UNLIndicatorManagerComponent* IndicatorManager = UNLIndicatorManagerComponent::GetComponent(PC))
		{
...
void UNLGameplayAbility_Interact::TriggerInteraction()
{
