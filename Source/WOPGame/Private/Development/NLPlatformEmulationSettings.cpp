...
#include UE_INLINE_GENERATED_CPP_BY_NAME(NLPlatformEmulationSettings)

#define LOCTEXT_NAMESPACE "NLCheats"

UNLPlatformEmulationSettings::UNLPlatformEmulationSettings()
{
}

FName UNLPlatformEmulationSettings::GetCategoryName() const
{
	return FApp::GetProjectName();
}

FName UNLPlatformEmulationSettings::GetPretendBaseDeviceProfile() const
{
	return PretendBaseDeviceProfile;
}

FName UNLPlatformEmulationSettings::GetPretendPlatformName() const
{
	return PretendPlatform;
}

#if WITH_EDITOR
void UNLPlatformEmulationSettings::PostEditChangeProperty(FPropertyChangedEvent& PropertyChangedEvent)
{
...
void UNLPlatformEmulationSettings::PostReloadConfig(FProperty* PropertyThatWasLoaded)
{
...
void UNLPlatformEmulationSettings::PostInitProperties()
{
...
void UNLPlatformEmulationSettings::OnPlayInEditorStarted() const
{
...
void UNLPlatformEmulationSettings::ApplySettings()
{
...
void UNLPlatformEmulationSettings::ChangeActivePretendPlatform(FName NewPlatformName)
{
...
TArray<FName> UNLPlatformEmulationSettings::GetKnownPlatformIds() const
{
...
TArray<FName> UNLPlatformEmulationSettings::GetKnownDeviceProfiles() const
{
	TArray<FName> Results;
...
void UNLPlatformEmulationSettings::PickReasonableBaseDeviceProfile()
{
